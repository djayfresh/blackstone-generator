...
execute unless score #b2b_e b2b_e matches 1 run tellraw @s [{"text":"["}, {"text":"Enable", "color": "green", "clickEvent":{"action":"run_command", "value":"/function blackstone:enable"},"hoverEvent":{"action":"show_text","value":"Enable blackstone generation"}}, {"text":"]"}]
