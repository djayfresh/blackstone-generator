...
- `images/`: Planet Minecraft images. `cover.png`, `setup.png` and `markers.png` are generated by `tools/release_art.py` from vanilla 26.3 textures; the `Blackstone_Generator*.png` files are the 2020 screenshots.
